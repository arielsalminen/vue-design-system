          ...
          p = (function() {
            ...
            return (
              (Shared.prototype.delegateCursor = function(o, e, r) {
                ...
                r && this.editor.focus(),
                  e ? n.setCursor(o) : n.setCursor(o, null, { scroll: !1 });
              }),
                ...
                Object.keys(r).some(function(o) {
                  ...
                  Object.keys(r).forEach(function(n) {
                    o.options.hasOwnProperty(n) &&
                      ...
                      (e.editor.setOption(n, r[n]),
                      e.mirror.setOption(n, r[n]));
                  }),
                  this.hydrated ||
                    (this.mounted && this.deferred
                      ? this.resolveChange()
                      : this.initChange(o.value || "")),
                  (this.hydrated = !0);
              }),
                  ...
                  this.editor.on("beforeChange", function(e, r) {
                    if (!o.emulating) {
                      ...
                      o.props.onBeforeChange &&
                        o.props.onBeforeChange(o.editor, o.deferred, n);
                    }
                  }),
                ...
                if (!c) {
                  ...
                  o.value !== this.props.value && (this.hydrated = !1),
                    this.props.autoCursor ||
                      ...
                      (e.cursor = this.editor.getCursor()),
                    this.hydrate(o),
                    this.appliedNext ||
                      (this.shared.applyNext(this.props, o, e),
                      (this.appliedNext = !0)),
      ...
      var n = r(0),
        ...
        u = (function() {
          ...
          return function(o, e, r) {
            return (
              e && defineProperties(o.prototype, e),
              r && defineProperties(o, r),
              o
            );
          };
        })();
            ...
            u(Editor, [
              {
                ...
                value: function shouldComponentUpdate(o) {
                  return !(
                    !this.getEditorConfig(o).readOnly ||
                    o.code === this.props.code
                  );
                }
              },
              {
