...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    filename: utils.assetsSystemPath("js/[name].[chunkhash].js"),
    chunkFilename: utils.assetsSystemPath("js/[id].[chunkhash].js"),
    library: "[name]",
    libraryTarget: "umd",
  },
  plugins: [
    ...
    new ExtractTextPlugin({
      filename: utils.assetsSystemPath("css/[name].[contenthash].css"),
    ...
    new OptimizeCSSPlugin({
      cssProcessorOptions: config.system.productionSourceMap ? { safe: true, map: { inline: false } } : { safe: true },
    }),
    // generate dist index.html with correct asset hash for caching.
    // you can customize output by editing /index.html
    // see https://github.com/ampedandwired/html-webpack-plugin
    new HtmlWebpackPlugin({
      filename: config.system.index,
      template: "index.html",
      inject: true,
      minify: {
        removeComments: true,
